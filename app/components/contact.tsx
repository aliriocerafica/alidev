            ...
            <div className="card-modern p-8 space-y-8">
              ...
              <div className="pt-6 border-t border-neutral-700">
                ...
                <div className="flex gap-4">
                  {[
                    { name: "GitHub", icon: "/svg/square-github.svg", url: "https://github.com/aliriocerafica" },
                    { name: "LinkedIn", icon: "/svg/linkedin.svg", url: "https://linkedin.com/in/aliriocerafica" },
                    ...
                    <motion.a
                      ...
                      className="w-10 h-10 bg-neutral-800 rounded-lg flex items-center justify-center hover:bg-[#7484dd]/20 transition-colors"
