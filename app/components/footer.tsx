          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-[#7484dd]/20 rounded-lg flex items-center justify-center">
                  <svg className="w-4 h-4 text-[#7484dd]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4">
              ...
              <div className="space-y-2">
                <a href="#about" className="block text-neutral-300 hover:text-[#7484dd] transition-colors">About</a>
                <a href="#Works" className="block text-neutral-300 hover:text-[#7484dd] transition-colors">Projects</a>
                <a href="#tech1" className="block text-neutral-300 hover:text-[#7484dd] transition-colors">Skills</a>
                <a href="#contact" className="block text-neutral-300 hover:text-[#7484dd] transition-colors">Contact</a>
              </div>
            </div>
          </div>
        </div>
